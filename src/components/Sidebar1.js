...
const Sidebar1 = memo(() => {
  return (
    <div className="relative bg-styles-visitor-customer shadow-[8px_0px_32px_rgba(0,_0,_6,_0.15)] w-[257px] h-[1953px] overflow-hidden shrink-0 text-left text-14xl text-styles-empir-text-gul font-h6-16px-regular-inter">
      <div className="absolute top-[0px] left-[0px] shrink-0 flex flex-col items-start justify-start">
        <div className="w-[257px] h-[76px] overflow-hidden shrink-0 flex flex-row items-center justify-start pt-6 px-8 pb-4 box-border relative gap-[8px]">
          <div className="relative w-[34px] h-[55px] z-[0]">
            <img
          ...
          <div className="absolute my-0 mx-[!important] top-[20.5px] left-[94px] leading-[130%] font-medium inline-block w-40 shrink-0 z-[1]">
            EMPIR
          </div>
        </div>
        <div className="relative bg-styles-separator w-[257px] h-px" />
      </div>
      <div className="absolute top-[93px] left-[0px] shrink-0 flex flex-col items-center justify-center gap-[8px] text-base text-ffffff-bg-1">
