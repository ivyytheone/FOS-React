...
const Sidebar22 = memo(() => {
  return (
    <div className="relative bg-styles-visitor-customer shadow-[8px_0px_32px_rgba(0,_0,_6,_0.15)] w-[257px] h-[1953px] overflow-hidden shrink-0 text-left text-base text-ffffff-bg-1 font-h6-16px-regular-inter">
